...
namespace ast_visitor {
	class AstPrinter final : public AstVisitor</* Self = */AstPrinter, /* ExpressionResult = */void, /* StatementResult = */void, /* DeclarationResult = */void> {
	private:
		using Parent = AstVisitor<AstPrinter, void, void, void>;
	...
	public:
		AstPrinter(utils::IndentPrinter printer);
